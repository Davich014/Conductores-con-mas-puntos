...
public class DriversResultsApp extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        buttonFilter.setStyle("-fx-background-color: #FF0000; -fx-text-fill: #ffffff;");

        Button buttonReset = new Button("Todos los conductores");
        buttonReset.setOnAction(e -> {
            tableView.setItems(driverStandings);
        });
        buttonReset.setStyle("-fx-background-color: #FF0000; -fx-text-fill: #ffffff;");
        
        root.setBottom(new BorderPane(null, null, buttonFilter, null, buttonReset));
